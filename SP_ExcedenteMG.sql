...
BEGIN
  ...
  */
  ...
  FOR NF_ENTRADA IN ( 
					SELECT DISTINCT A.REC_ID, A.ID_ENTRADA, E.VOLUME, E.VL_BASE_ST, E.VL_BC_ST_UNIT
					FROM USRASSISTENTEFISCAL.Excedente_MG_SAIDAXENT A
  ...
  BEGIN
    ...
    (
      SELECT
        ID_ENTRADA, VL_BC_ST_UNIT_MEDIO
