...
CREATE OR REPLACE FUNCTION USRASSISTENTEFISCAL.FN_EXCEDENTE_ULT_ENT(P_FILIAL IN VARCHAR2, P_DATA_VENDA IN DATE, P_DATA_CORTE IN DATE, P_MERC_CODIGO IN VARCHAR)
             ...
             MULTISET (
                  ...
                  WHERE
                    (NFE.DOF_IMPORT_NUMERO, NEI.MERC_CODIGO)   = (
                                            ...
                                            (
                                              SELECT
                                                NEI2.MERC_CODIGO,NFE2.DOF_IMPORT_NUMERO, MAX(NFE2.DT_FATO_GERADOR_IMPOSTO) MIN_DATA
